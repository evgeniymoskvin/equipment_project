...
from .models import EquipmentModel, EquipmentSpecificationsModel, TypeOfEquipmentModel, TypeOfCoreModel, \
    TypeOfHardDiskModel, TypeOfVideoCardModel, TypeOfRAMModel
...
class EquipmentSpecificationsAdmin(admin.ModelAdmin):
    ...
    list_filter = ("equipment_type","core", "ram", 'video_card', 'disk', 'diagonal', 'type_of_print', 'paper_format', 'count_ethernet_ports')
...
class EquipmentAdmin(admin.ModelAdmin):
    ...
    list_display = ('equipment_type', 'equipment_name', 'equipment_model', 'equipment_spec', 'equipment_serial_number', 'equipment_inventory_number','barcode','description')
